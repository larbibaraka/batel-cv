...
const PersonalDetails = ({ title }: any) => {
        ...
        <div className="flex space-x-2">
          <Form {...form}>
            ...
            >
              ...
              <div className="space-y-4">
                <h3 className="text-primary font-bold text-2xl">Links</h3>
            ...
            <div className="w-1/3  items-start justify-center flex mt-9">
              <div className="indicator">
                <button
                  role="button"
                  className="indicator-item indicator-bottom rounded-full   bg-purple-400 w-10 h-10 p-2 hover:bg-purple-300"
                >
                  <Edit2 className="" />
                </button>
